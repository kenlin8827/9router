...
export const APIKEY_PROVIDERS = {
  ...
  alitp: { id: "alitp", alias: "alitp", name: "Aliyun Token Plan", icon: "cloud", color: "#FF6A00", textIcon: "ATP", website: "https://token-plan.cn-beijing.maas.aliyuncs.com", notice: { apiKeyUrl: "https://token-plan.cn-beijing.maas.aliyuncs.com" } },
